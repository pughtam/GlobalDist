...
base_folder_name_h='/media/pughtam/rds-2017-pughtam-treemort/hansen_esaLUcorr_p100/postproc';
base_folder_name_hmin='/media/pughtam/rds-2017-pughtam-treemort/hansen_esaLUcorr_lower_p10/postproc';
base_folder_name_hmax='/media/pughtam/rds-2017-pughtam-treemort/hansen_esaLUcorr_upper_p10/postproc';
...
[mdistc_tot_TrBE_h,mdistc_tot_TrBD_h,mdistc_tot_TeBE_h,mdistc_tot_TeBD_h,mdistc_tot_BNE_h,mdistc_tot_BNS_h,mdistc_tot_MX_h,mdistc_tot_h,...
    ...
    mdistc_h,mmortc_h,mtotc_h]=dist_loss_maps_esa_func_v3(base_folder_name_h,thres25);
...
[mdistc_tot_TrBE_hmin,mdistc_tot_TrBD_hmin,mdistc_tot_TeBE_hmin,mdistc_tot_TeBD_hmin,mdistc_tot_BNE_hmin,mdistc_tot_BNS_hmin,mdistc_tot_MX_hmin,mdistc_tot_hmin,...
    ...
    mdistc_hmin,mmortc_hmin,mtotc_hmin]=dist_loss_maps_esa_func_v3(base_folder_name_hmin,thres25);
...
[mdistc_tot_TrBE_hmax,mdistc_tot_TrBD_hmax,mdistc_tot_TeBE_hmax,mdistc_tot_TeBD_hmax,mdistc_tot_BNE_hmax,mdistc_tot_BNS_hmax,mdistc_tot_MX_hmax,mdistc_tot_hmax,...
    ...
    mdistc_hmax,mmortc_hmax,mtotc_hmax]=dist_loss_maps_esa_func_v3(base_folder_name_hmax,thres25);

%---
%Fraction of total mortality as disturbance
dist_mort_frac=[mdistc_tot_TrBE_h/mmortc_tot_TrBE_h*100,mdistc_tot_TrBD_h/mmortc_tot_TrBD_h*100,mdistc_tot_TeBE_h/mmortc_tot_TeBE_h*100,...
